...
// gl_FragColor = mix(color4, fogColor4, fogAmount);

// gl_FragColor = vec4( color, gl_FragCoord.z );
...
// float fogFactor = exp2( fogAmount * z * z * LOG2 );
...
// float ndcZ = -20.0*z + 10.0;  // [-1,1]
//
// float factor = exp2( z * z * LOG2 );
// factor = clamp(factor, 0.0, 1.0);
//
// float linearDepth = (2.0 * near * far) / (far + near - ndcZ * (far - near));
//
// gl_FragColor.rgb = color;
// gl_FragColor.a = linearDepth/far;
